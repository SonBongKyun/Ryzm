/* ?ê‚ïê??3. AI Council ??Multi-Framework Analysis Engine v6.0 ?ê‚ïê??*/

/* ?Ä?Ä Framework Avatar SVGs ?Ä?Ä */
...
/* ?Ä?Ä Loading Steps Controller ?Ä?Ä */
...
/* ?Ä?Ä Auto Analysis Status Bar ?Ä?Ä */
...
/* ?ê‚ïê??Narrative Radar Chart ?ê‚ïê??*/
...
function displayValidationResult(data) {
  ...
  resultDiv.innerHTML = `
    ...
    <div class="val-summary">?ìä ${escapeHtml(data.summary)}</div>
  `;
...
/* ?Ä?Ä Quota Refresh (called after any 403) ?Ä?Ä */
